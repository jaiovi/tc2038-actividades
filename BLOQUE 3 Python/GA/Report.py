...
class Report:
    def __init__(self, number_executions, Gmax):
        ...
        self.final_individual_per_execution = np.empty(number_executions, dtype=Individual)
        self.best_individual_per_generation = np.empty((number_executions, Gmax), dtype=Individual)
    ...
    def add_final_individual_from_execution(self, execution, individual):
        self.final_individual_per_execution[execution] = individual
    ...
    def add_best_individual_at_generation(self, generation, execution, individual):
        self.best_individual_per_generation[execution][generation] = individual       
